...
@section('title', 'Profile') {{-- still used by layout if needed --}}
    ...
    <div class="col-md-12 stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin_dashboard_update_profile') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="phone_number" value="0{{ old('phone_number', $admin->phone_number) }}">
                            </div>

                            <div class="form-group mb-4">
                                <label for="address">📍 Address</label>
                                <textarea class="form-control" name="address" rows="3">{{ old('address', $admin->address) }}</textarea>
                            </div>

                            @if ($admin->img_url)
                                <img src="{{ asset('storage/' . $admin->img_url) }}" class="rounded-circle mb-2" width="100" height="100" alt="Admin Avatar">
                            @else
                ...
                <form method="POST" action="{{ route('admin_dashboard_update_password') }}">
                    @csrf
